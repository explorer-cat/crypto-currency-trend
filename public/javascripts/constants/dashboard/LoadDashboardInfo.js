    ...
    getUpbitCoinInfo(async function (result) {
        switch(result.code)  {
            case "KRW-BTC":
                ...
                document.getElementById('upbit_BTC_acc_trade_volume_24h').innerHTML = `24시간 거래량 : ${result.acc_trade_volume_24h.toLocaleString()} BTC`; 
            ...
            case "KRW-ETH":
                ...
                document.getElementById('upbit_ETH_acc_trade_volume_24h').innerHTML = `24시간 거래량 : ${result.acc_trade_volume_24h.toLocaleString()} ETH`; 
            ...
            case "KRW-XRP":
                ...
                document.getElementById('upbit_XRP_acc_trade_volume_24h').innerHTML = `24시간 거래량 : ${result.acc_trade_volume_24h.toLocaleString()} XRP`; 
